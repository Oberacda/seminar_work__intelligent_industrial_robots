...
The importance as a system programming language has also sparked intensive research in the field of formal verification of C code\todo[color=green]{Add citation for formal C verification programs.}.
...
Many model driven systems and simulators allow for the generation of C code from a model, therefore C support is a important part for automated programming when looking at non PLC specific programming methods.
...
B \& R Automation Studio~\cite{b-r_automation:2020} is the~\acrshort{acn:plc} development environment for solutions by the Austrian company B\&R, a subsidiary of the swiss company ABB, one of the worlds leading PLC manufactures.
...
This makes it a environment with good support for all kinds of use cases and application domains.

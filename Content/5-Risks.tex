...
It is assumed that the system was designed in a way that would keep it in a safe state for common errors, as long as software behaves like specified in the design.

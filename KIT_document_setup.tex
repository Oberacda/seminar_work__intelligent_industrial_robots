...
\usepackage[breaklinks,colorlinks=true,xetex,pageanchor=false]{hyperref}
...
\newcommand{\todoCopied}[1]{\todo[color=yellow]{This is copied and needs to bo reworded: #1}}
\newcommand{\todoCopiedin}[1]{\todo[color=yellow,inline]{This is copied and needs to bo reworded:} {\color{yellow}#1}}
